...
const Form = () => {
  ...
  const serv = useSelector((state)=> state.allServices)
    ...
    return(
        ...
        <div className="error">{error.date && <span >{error.date}</span>} </div>
        ...
        <div className="error">{error.hour && <span >{error.hour}</span>} </div>

        <div className="inputBox">
          <input
            className="input"
            type="text"
            value={form.ProfessionalId} readOnly
           onChange={changeHandler}
            name="ProfessionalId"
          />
        ...
        <select name="ServiceId" onChange={handleSelectServ} className="desplegable">
         ...
         <div className="error">{error.ServiceId && <span >{error.ServiceId}</span>} </div>
        </select>
        ...
        <button className="enterForm" type="submit">TAKE TURN</button>
